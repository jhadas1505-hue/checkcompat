...
with tab1:
    ...
    with col1:
        ...
        if st.button("❤️ Simpan ke Favorit", key="fav_a"):
            entry = {
                "id": chem_a["id"],
                "name": chem_a["name"],
                "formula": chem_a["formula"],
                "cas": chem_a["cas"],
                "category": chem_a["category"]
            }
    ...
    with col2:
        ...
        if st.button("❤️ Simpan ke Favorit", key="fav_b"):
            entry = {
                "id": chem_b["id"],
                "name": chem_b["name"],
                "formula": chem_b["formula"],
                "cas": chem_b["cas"],
                "category": chem_b["category"]
            }
    ...
    if compat:
        ...
        st.info("Data kompatibilitas untuk kombinasi ini belum tersedia. Asumsikan perlu dipisahkan dan konsultasikan MSDS masing-masing bahan.")
